...
/**
 * Settings — the account/app tab. It folds together what used to be two tabs:
 * the account + theme + API-usage controls (formerly "Settings") and the
 * "Nearest ___" / route preferences, saved places and favourite routes.
 */
...
/** Account + theme (moved here from the retired Settings tab). */
function AccountSection() {
  ...
  return (
    <section>
      <h2 className="eyebrow mb-2 text-ripple-muted">Account</h2>
...
/** HERE API usage meter + data attribution (moved from the Settings tab). */
function ApiUsageSection() {
  ...
  return (
    <section>
      <h2 className="eyebrow mb-2 text-ripple-muted">API usage — HERE</h2>
      <Card className="p-4">
        {usage.data && (
          <>
      ...
      <p className="mt-3 px-1 text-[11px] leading-relaxed text-ripple-muted">
        Map data ©{" "}
        <a
